...
namespace CAESAR.Chess.Tests
{
    public class SquareTests
    {
        ...
        {
            _board = board;
            _darkSquare = new Square(_board, _board.Files.ElementAt(0), _board.Ranks.ElementAt(0), "a1", false);
            _lightSquare = new Square(_board, _board.Files.ElementAt(7), _board.Ranks.ElementAt(2), "h3", false);
