...
namespace CAESAR.Chess.Moves.Generation
{
    ...
    public class KingMovesGenerator : MovesGenerator
    {
        ...
        ///     <seealso cref="KingMovesGenerator" /> this includes two <seealso cref="CastlingMove" />s which may be available
        ///     based on the position.
        /// </summary>
        protected override IEnumerable<IMove> SpecialMoves => GetCastlingMoves();

        /// <summary>
        ///     The <seealso cref="ISquare" />s to which the <seealso cref="King" /> can move, from
        ...
        /// <summary>
        ///     Gets the <seealso cref="CastlingMove" />s available for the <seealso cref="King" /> in the
        ///     <seealso cref="IMovesGenerator.Square" />.
        /// </summary>
        /// <returns>
        ///     The <seealso cref="CastlingMove" />s available for the <seealso cref="King" /> in the
        ///     <seealso cref="IMovesGenerator.Square" />.
        /// </returns>
